...
// OSPF6InterfaceResourceModel is the Terraform state model for opnsense_quagga_ospf6_interface.
...
type ospf6InterfaceAPIResponse struct {
...
type ospf6InterfaceAPIRequest struct {
	Enabled       string `json:"enabled"`
...
func (m *OSPF6InterfaceResourceModel) toAPI(_ context.Context) *ospf6InterfaceAPIRequest {
	return &ospf6InterfaceAPIRequest{
...
func (m *OSPF6InterfaceResourceModel) fromAPI(_ context.Context, a *ospf6InterfaceAPIResponse, id string) {
