...
This checklist provides a comprehensive validation framework for infrastructure changes across all phases of planning, implementation, and operations. Each section should be reviewed and verified before promoting infrastructure changes to production. Items not applicable to a specific change should be marked as N/A with justification.
...
- [ ] Infrastructure changes support development agent requirements
...
- [ ] Infrastructure changes mapped to PRD requirements
...
- [ ] Technical constraints documented and shared
...
- [ ] Environment promotion pipelines operational (dev to staging to prod)
...
- [ ] Infrastructure changes verified against architectural decisions
